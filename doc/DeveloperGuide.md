...
`* *` | user | connect with telegram | easily communicate with people in my address book
...
1. User requests to list persons
2. AddressBook shows a list of persons
3. User requests to rename tag of all the people in the list.
4. Addressbook will prompt for confirmation about the rename.
5. User accepts the change.
6. AddressBook renames the person's tag <br>
Use case ends.
...
5. Should regularly keep a backup of the database.
