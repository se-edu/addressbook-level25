...
* https://se-edu.github.io/se-book/oop/abstractClasses/[se-edu/se-book: Implementation: OOP: Abstract Classes]
...
* https://se-edu.github.io/se-book/oop/interfaces/[se-edu/se-book: Implementation: OOP: Abstract Interfaces]
