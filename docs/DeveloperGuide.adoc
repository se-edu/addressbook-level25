...
. AddressBook shows a list of existing tags.
. User changes tag from 'friends' to 'buddies'.
. AddressBook asks for confirmation the change of tag.
. User confirms the changing of tag.
. AddressBook changes the tag from 'friends' to 'buddies'.
+
Use case ends.
