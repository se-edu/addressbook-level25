...
|`* * *` |user |add multiple phone numbers to a person | keep track of people with multiple phone/work numbers
|`* * *` |user | assign people to categories | keep track of my relationships with people (colleagues/friends)
