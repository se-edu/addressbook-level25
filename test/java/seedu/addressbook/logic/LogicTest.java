...
public class LogicTest {
    ...
    private StorageStub stubSaveFile;
    private AddressBook addressBook;
    private Logic logic;

    @Before
    public void setup() throws Exception {
        stubSaveFile = new StorageStub(saveFolder.newFile("testSaveFile.txt").getPath());
        addressBook = new AddressBook();
        stubSaveFile.save(addressBook);
        logic = new Logic(stubSaveFile, addressBook);
    }
    ...
    private void assertCommandBehavior(String inputCommand,
        ...
        assertEquals(addressBook, stubSaveFile.load());
    }
