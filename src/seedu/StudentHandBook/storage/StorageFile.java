...
import seedu.StudentHandBook.storage.jaxb.AdaptedAddressBook;
...
public class StorageFile {
    ...
    public static final String DEFAULT_STORAGE_FILEPATH = "StudentHandBook.txt";
     ...
     */
    public void save(StudentHandBook studentHandBook) throws StorageOperationException {
        ...
        try (final Writer fileWriter =
            ...
            final AdaptedAddressBook toSave = new AdaptedAddressBook(studentHandBook);
     ...
     */
    public StudentHandBook load() throws StorageOperationException {
        ...
        // create empty file if not found
            ...
            final StudentHandBook empty = new StudentHandBook();
            save(empty);
            return empty;
